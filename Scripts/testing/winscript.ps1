...
Write-Host -- Google.Chrome AnyDesk.AnyDesk VideoLAN.VLC Zoom.Zoom Adobe.Acrobat.Reader.64-bit Microsoft.Office
Stop-Process -Name explorer -Force -ErrorAction SilentlyContinue | Start-Process explorer.exe | Start-Process cmd.exe -ArgumentList '/k "winget install Google.Chrome AnyDesk.AnyDesk VideoLAN.VLC Zoom.Zoom Adobe.Acrobat.Reader.64-bit Microsoft.Office --accept-source-agreements --accept-package-agreements --force"'
# Pause the script
Pause
# Exit the script
